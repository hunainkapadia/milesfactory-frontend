  ...
  const BaggageDrawer = ({ getFlightDetail }) => {
    ...
    const totalBaggageCount = Object.values(baggageCount).reduce((passengerTotal, baggageMap) => {
      const baggageSum = Object.values(baggageMap).reduce((sum, count) => sum + count, 0);
                  ...
                  <>
                    ...
                    >
                      ...
                      <h4 className={`${styles.title} mb-0`}>
                        ...
                        {
                          getselectedFlight.slices[tabValue].destination
                            .city_name
                        }
                      </h4>
