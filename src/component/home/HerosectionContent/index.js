       ...
       <Box className={styles.Content}>
         ...
         >
           ...
           >
             ...
             <Typography className={"333"} component={"h1"}  sx={{lineHeight:"120%", display: { lg: "block", md: "block", xs: "none" }, mb:"6px", fontSize:{lg:"48px", md:"48px", xs:"36px"} }} className=" semibold test-444">
